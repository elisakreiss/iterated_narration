...
df = read_csv(here("data","01_pilot","03_biggerInitMTurk","raw.csv"))
...
write.csv(clean, file = here("data","01_pilot","03_biggerInitMTurk","flowchart_data.csv"), row.names = FALSE)
