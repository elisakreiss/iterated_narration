...
var instructions = {
    ...
    "title": "Instructions",
    // instruction's text
    "text": "Imagine you are an intern in a <strong>lawyer’s office</strong>. Your boss likes to stay up-to-date about potentially interesting or groundbreaking cases. Your task is to go through the following two crime reports and brief your boss on the contents. <br><br><strong>Please do not take notes.</strong> Make sure to retell the story immediately after reading the original. <br><p><strong>Notice:</strong> You may experience lags during the experiment, because the experiment communicates with a data base. Please just be patient, as the experiment should resume soon enough.",
...
var main = {
    ...
    render : function(CT) {
		...
		$.ajax({
				type: 'GET',
				url: "https://babe-backend.herokuapp.com/api/retrieve_experiment/14",
				crossDomain: true,
