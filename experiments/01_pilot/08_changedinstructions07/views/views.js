var intro = {
    ...
    "title": "Welcome!",
    // introduction text
    "text": "Thank you for participating in our study. In this study, we test your memory. You will read two stories and are asked to reproduce them as accurately as you can.",
...
var instructions = {
    ...
    "title": "Instructions",
    // instruction's text
    "text": "In each of the two trials of this experiment, you will read a short story. You are then asked to retell this story, which is the main part of our memory experiment. <strong>Please do not take notes and do not copy-paste your answer.</strong> Make sure to retell the story immediately after reading the original.<p><br><strong>Notice:</strong> You may experience lags during the experiment, because the experiment communicates with a data base. Please just be patient, as the experiment should resume soon enough.",
...
var main = {
    ...
    render : function(CT) {
		...
		$.ajax({
				type: 'GET',
				url: "https://babe-backend.herokuapp.com/api/retrieve_experiment/18",
				crossDomain: true,
...
//             $('#next_trial').removeClass('nodisplay');
//         });
//         response1.on('click', function() {
//             $('#next_trial').removeClass('nodisplay');
//         });

//         $('#next_trial').on('click', function() {
//             hide("question1");
//             hide("next_trial");
//             show("question2");
//         });
...
//             exp.trial_data[0]["guilty"] = response1.val()
//             exp.trial_data[1]["guilty"] = response2.val()
//             exp.findNextView();
//         });
