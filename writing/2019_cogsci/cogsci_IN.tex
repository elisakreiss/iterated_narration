...
\begin{figure}[H]
	...
	\caption{Mean ratings  in strong (orange) and weak (green) evidence condition for each dimension (facets). \jd{elisa, put these all in one row, make the x-axis labels not slanted, and make it a two-column figure} \ek{judith: I don't know what you mean here with all in one row but only two columns?}} 
